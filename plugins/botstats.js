...
conn.sendButtonDoc(m.chat, '▷ʙᴏᴛ sᴛᴀᴛᴜs◁', sts, 'Owner', '.owner', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https//wa.me/6283822205585?text=Hᴀʟᴏ+ɢᴀɴᴛᴇɴɢᴋᴜ',
    mediaType: 2, 
    description: 'wa.me/6283822205585?text=Hᴀʟᴏ+ɢᴀɴᴛᴇɴɢᴋᴜ',
    title: "Iɴɪ Fᴀᴄᴇʙᴏᴏᴋ Gᴡ!",
    body: wm,
    thumbnail: fs.readFileSync('./thumbnail.jpg'),
    sourceUrl: 'https://www.facebook.com/taufiqurrohman.opik.750'
     }}
  })
